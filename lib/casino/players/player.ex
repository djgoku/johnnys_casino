defmodule Casino.Player.Greg do
    ...
    def handle_call(:hit_or_stay, _from, state) do
      ...
      hit_or_stay = case {sum_hand, sum_dealer} do
        ...
        {our_pairs, dealer_pairs} ->
            if Enum.max(our_pairs) < Enum.max(dealer_pairs) do :hit else :stay end
      end
